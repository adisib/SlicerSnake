...
Game Controls:
Use the arrow keys or WASD to move your snake. Pressing enter/return will pause the game. 

Build Instructions:
At least Linux (using ncurses) and Windows (using pdcurses) are supported, but this repository is set up for easy linux builds.
